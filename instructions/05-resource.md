...
2. Create a new File named **[template_withresource.json](../lambda/custom/documents/template_withresource.json)** in Folder ```lambda/documents``` and paste the `Start from Scratch` from the **APL Authoring Tool** into this file
